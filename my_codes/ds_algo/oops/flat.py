...
class Flat():
    ...
    def rent_out(self):
        if self.current_renter == None:
            ...
            user_input = input(f"Do you want to take this flat on rent in {rent} amount , type Yes/yes/y :  ")
            if user_input == 'Y' or user_input == 'Yes' or user_input == 'yes':
                user_name = input("Please enter your name : ")
                self.current_renter = user_name
                print(f"The renter of the flat is {self.current_renter}")
                return rent
...
new_flat = Flat([],[],[],None,None)

# to check code uncomment below line
